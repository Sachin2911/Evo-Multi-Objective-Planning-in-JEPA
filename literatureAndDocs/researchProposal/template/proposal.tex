...
\begin{figure}[ht]
    \centering
    \subfigure[Reacher]{\includegraphics[width=0.30\linewidth]{images/reacher}\label{fig:env-reacher}}
    \hfill
    \subfigure[Push-T]{\includegraphics[width=0.30\linewidth]{images/pusht}\label{fig:env-pusht}}
    \hfill
    \subfigure[OGBench-Cube]{\includegraphics[width=0.30\linewidth]{images/og-cube}\label{fig:env-ogcube}}
